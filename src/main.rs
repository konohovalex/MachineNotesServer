...
async fn main() -> std::io::Result<()> {
    ...
    let account_database_connection_pool =
        postgres_database_connection::get_database_connection_pool();

    HttpServer::new(move || {
        App::new()
            .wrap(HttpAuthentication::bearer(middleware::bearer_auth_validator))
